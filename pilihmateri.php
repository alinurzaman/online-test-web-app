...
<head>
	...
	<title>UC ONLINE LBB BEST | PILIH MATERI UPLOAD SOAL UC</title>
	<meta name="description" content="TO LBB BEST PILIH MATERI UPLOAD SOAL UC" />
						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Pilih Materi Soal Yang Akan Diupload</h6>
									</div>
											...
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													...
													<tr>
														...
														<td><a href="pilihmateri.php?idu=<?php echo $data_uc['id_uc'];?>"><button class="btn btn-primary btn-anim"><i class="fa fa-pencil-square-o"></i><span class="btn-text">Pilih</span></button></a></td>
													</tr>
													<?php }?>
												</tbody>
											</table>
