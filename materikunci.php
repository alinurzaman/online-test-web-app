...
<head>
	...
	<title>UC ONLINE LBB BEST | PILIH MATERI KUNCI UC</title>
	<meta name="description" content="TO LBB BEST PILIH MATERI KUNCI UC" />
						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Pilih Materi</h6>
									</div>
									<div class="clearfix"></div>
								</div>
							<?php
								$get_materi = mysql_query("SELECT * FROM materi WHERE id_uc='$id_uc'");
							?>
									...
									<div class="table-wrap">
										<div class="table-responsive">
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													<?php $i=1; while($data_materi=mysql_fetch_array($get_materi)){?>
													<tr>
														<td><?php echo $i;?></td>
														<td><?php echo $data_materi['tipe_materi'];?></td>
														<td><?php echo $data_materi['ujian_materi'];?></td>
														<td><?php echo $data_materi['jmlsoal_materi'];?></td>
														<td>
															<?php if ($data_materi['kunci_materi']=='BELUM DIUPLOAD'){?>
															<a href="formuploadkunci.php?idm=<?php echo $data_materi['id_materi'];?>&idu=<?php echo $id_uc;?>"><button class="btn btn-primary btn-anim"><i class="fa fa-pencil-square-o"></i><span class="btn-text">Upload Kunci</span></button></a>
															<?php } else { echo $data_materi['kunci_materi'];} ?>
														</td>
													</tr>
													<?php $i++; }?>
												</tbody>
