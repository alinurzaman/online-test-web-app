...
<head>
	...
	<title>UC ONLINE LBB BEST | PILIH UPLOAD KUNCI UC</title>
	<meta name="description" content="TO LBB BEST PILIH UPLOAD KUNCI UC" />
						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Pilih UC</h6>
									</div>
											...
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<a href="materikunci.php?idu=<?php echo $data_uc['id_uc'];?>"><button class="btn btn-primary btn-anim"><i class="fa fa-pencil-square-o"></i><span class="btn-text">Pilih</span></button></a>
														</td>
													</tr>
													<?php }?>
												</tbody>
