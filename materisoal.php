...
<head>
	...
	<title>UC ONLINE LBB BEST | PILIH MATERI SOAL UC</title>
	<meta name="description" content="TO LBB BEST PILIH MATERI SOAL UC" />
											...
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<?php if ($data_materi['status_materi']=='BELUM DIUPLOAD'){?>
															<a href="formuploadsoal.php?idm=<?php echo $data_materi['id_materi'];?>&idu=<?php echo $id_uc;?>"><button class="btn btn-primary btn-anim"><i class="fa fa-pencil-square-o"></i><span class="btn-text">Upload Soal</span></button></a>
															<?php } else { echo $data_materi['status_materi'];} ?>
														</td>
													</tr>
													<?php $i++; }?>
												</tbody>
