...
<head>
	...
	<title>UC ONLINE LBB BEST | DETAIL MATERI</title>
						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Data Materi UC</h6>
									</div>
											...
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													...
													<tr>
														...
														<td contenteditable="true" onBlur="saveToDatabase(this,'jmlsoal_materi','<?php echo $data_materi["id_materi"]; ?>')" onClick="showEdit(this);"><?php echo $data_materi['jmlsoal_materi'];?></td>
														<td contenteditable="true" onBlur="saveToDatabase(this,'nilaimati_materi','<?php echo $data_materi["id_materi"]; ?>')" onClick="showEdit(this);"><?php echo $data_materi['nilaimati_materi'];?></td>
														<td contenteditable="true" onBlur="saveToDatabase(this,'batasnilai_materi','<?php echo $data_materi["id_materi"]; ?>')" onClick="showEdit(this);"><?php echo $data_materi['batasnilai_materi'];?></td>
														<td contenteditable="true" onBlur="saveToDatabase(this,'waktu_materi','<?php echo $data_materi["id_materi"]; ?>')" onClick="showEdit(this);"><?php echo $data_materi['waktu_materi'];?></td>
													</tr>
													<?php $i++; }?>
												</tbody>
											</table>
