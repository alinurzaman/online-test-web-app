...
<head>
	...
	<title>UC ONLINE LBB BEST | INPUT SISWA</title>
	<meta name="description" content="TO LBB BEST INPUT SISWA" />
    ...
    <div class="wrapper theme-1-active pimary-color-red">
		...
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<a href="inputsiswa.php" class="active"><div class="pull-left"><i class="zmdi zmdi-account-add mr-20"></i><span class="right-nav-text">Input Siswa</span></div><div class="clearfix"></div></a>
				</li>
				<li>
					...
					<div class="col-sm-6">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Form Input Siswa Baru</h6>
									</div>
										...
										<div class="form-wrap">
											<form class="form-horizontal" method="post" action="" name="create">
												<div class="form-group">
													<label class="control-label mb-10 col-sm-3" for="nama">Nama Siswa:</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" name="nama" placeholder="Maksimum 35 karakter" style="text-transform: uppercase" maxlength="35">
												</div>
												</div>
													...
													<?php
														if (isset($_POST['submit'])==true){
															...
															if($nama != ""){
																...
																$insert = mysql_query("INSERT INTO siswa VALUES('$id_siswa', '$nama', PASSWORD('BEST1'), $id_cabang)");
																if($insert){
																	echo '<script language="javascript">alert("Input siswa baru berhasil!");document.location="inputsiswa.php"</script>';
																}
																else{
																	echo '<script language="javascript">alert("Input siswa baru gagal!");</script>';
																}
															}
															else{
																echo '<script language="javascript">alert("Nama siswa belum diisi!");</script>';
															}
														}
													?>
										</div>
