...
<head>
	...
	<title>UC ONLINE LBB BEST | RESET PASSWORD SISWA</title>
	<meta name="description" content="TO LBB BEST RESET PASSWORD SISWA" />
    ...
    <div class="wrapper theme-1-active pimary-color-red">
		...
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<a href="resetpassword.php" class="active"><div class="pull-left"><i class="zmdi zmdi-key mr-20"></i><span class="right-nav-text">Reset Password Siswa</span></div><div class="clearfix"></div></a>
				</li>
				<li>
					...
					<div class="col-sm-6">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Form Reset Password Siswa</h6>
									</div>
										...
										<div class="form-wrap">
											<form class="form-horizontal" method="post" action="" name="create">
												<div class="form-group">
													<label class="control-label mb-10 col-sm-3" for="nama">ID Siswa:</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" name="id" placeholder="Maksimum 8 karakter" style="text-transform: uppercase" maxlength="8">
												</div>
												</div>
												<div class="form-group mb-0"> 
													<div class="col-sm-offset-3 col-sm-10">
													  <button name="submit" type="submit" class="btn btn-success btn-anim"><i class="icon-rocket"></i><span class="btn-text">Reset</span></button>
													</div>
												</div>
												</form>
													<?php
														if (isset($_POST['submit'])==true){
															$id = $_POST['id'];
															if($id != ""){
																$update = mysql_query("UPDATE siswa SET password_siswa=PASSWORD('BEST1') WHERE id_siswa='$id'");
																if($update){
																	echo '<script language="javascript">alert("Reset berhasil! Password: BEST1");document.location="resetpassword.php"</script>';
																}
																else{
																...
																echo '<script language="javascript">alert("ID siswa belum diisi!");</script>';
															}
														}
													?>
										</div>
