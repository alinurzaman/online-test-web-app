...
<head>
	...
	<title>UC ONLINE LBB BEST | DASHBOARD</title>
	<meta name="description" content="TO LBB BEST DASHBOARD" />
    ...
    <div class="wrapper theme-1-active pimary-color-red">
		...
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<a class="active" href="index.php"><div class="pull-left"><i class="zmdi zmdi-inbox mr-20"></i><span class="right-nav-text">Dashboard</span></div><div class="pull-right"></div><div class="clearfix"></div></a>
				</li>
					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">Hello, selamat datang <?php echo $data_siswa['nama_siswa']; ?> !</h6>
								</div>
								<div class="clearfix"></div>
							</div>
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<p>Pilih menu pada panel sebelah kiri untuk memulai UC.</p>
									<p><strong>PASTIKAN:</strong><BR>1. Tanggal dan Jam di HP/Laptop/Komputer sudah sesuai dengan waktu sekarang, jika belum, lakukan update waktu terlebih dahulu. Caranya: <a href="http://www.tipstriks.com/2011/11/singkronisasi-jam-waktu-di-komputer.html" target="_blank">Klik disini.</a><br>2. Gunakan Google Chrome versi terbaru. Caranya: <a href="https://www.google.com/chrome/" target="_blank">Klik disini.</a><br>3. Koneksi internet harus lancar min. 1 Mbps. Cek kecepatan: <a href="http://www.speedtest.net/" target="_blank">Klik disini.</a><br>4. Disarankan mengerjakan UC menggunakan Laptop/Komputer.</p>
								</div>
							</div>
						</div>
					</div>
