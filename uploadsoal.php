...
<head>
	...
	<title>UC ONLINE LBB BEST | PILIH UPLOAD SOAL UC</title>
	<meta name="description" content="TO LBB BEST PILIH UPLOAD SOAL UC" />
											...
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<a href="materisoal.php?idu=<?php echo $data_uc['id_uc'];?>"><button class="btn btn-primary btn-anim"><i class="fa fa-pencil-square-o"></i><span class="btn-text">Pilih</span></button></a>
														</td>
													</tr>
													<?php }?>
												</tbody>
