...
<head>
	...
	<title>UC ONLINE LBB BEST | INPUT MATERI</title>
	<meta name="description" content="TO LBB BEST INPUT MATERI" />
	<script>
	function disp_confirm()
	{
		var r=confirm("Anda yakin menghapus UC ini?")
		if (!r)
  		{
			return false;
  		}
    ...
    <div class="wrapper theme-1-active pimary-color-red">
		...
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<a href="inputmateri.php" class="active"><div class="pull-left"><i class="zmdi zmdi-keyboard mr-20"></i><span class="right-nav-text">Input Materi Ujian</span></div><div class="clearfix"></div></a>
				</li>
				<li>
						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Data UC</h6>
									</div>
									...
									<div class="table-wrap">
										<div class="table-responsive">
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													<?php while($data_uc=mysql_fetch_array($get_uc)){?>
													<tr>
														<td><?php echo $data_uc['id_uc'];?></td>
														<td><?php echo $data_uc['nama_uc'];?></td>
														<td><?php echo $data_uc['pin_uc'];?></td>
														<td><a href="detailmateri.php?id=<?php echo $data_uc['id_uc']; ?>"><img src="dist/img/icons8-overview-64.png" width="32px"></a></td>
														<td><form method="post" action="#" onsubmit="disp_confirm()">
                <a href="hapus.php?id=<?php echo $data_uc['id_uc']; ?>" style="text-decoration:none" onclick="return disp_confirm();"><img src="dist/img/icons8-delete-shield-64.png" width="32px"></a>
                </form></td>
													</tr>
													<?php }?>
												</tbody>
